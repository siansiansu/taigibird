...
description: 收錄布袋鵝科 pòo-tē-gô-kho ê 台語號名，做未來命名討論 ê 參考。
keywords: ["台語", "鳥類", "鳥仔", "台灣", "鳥名", "eBird", "布袋鵝", "鵜鶘"]
---

這頁收錄布袋鵝科 pòo-tē-gô-kho ê 台語號名，◆ 表示建議用名，◇ 表示別名或保留用法，△ 表示統稱。
...
- `虯毛布袋鵝 khiû-moo-pòo-tē-gô` 先保留做這个物種 ê 建議名，作為目前檔內整理後 ê 主推形式。
